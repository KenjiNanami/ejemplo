...
<?php
    ...
    $result=mysqli_query($link,"select * from crearp_electiva");
...
?>                
        ...
        <tr>
            ...
            <td><option><?php echo $row['elect_cupos']; ?></option></td> 
            <td><a href="#x<?php echo $row['elect_cod'];?>"  title="Editar" role="button" class="button4 modal-trigger" style="width:60%;">Inscribirse</a>
